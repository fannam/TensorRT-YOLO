...
{
    if (argc < 3 || argc > 4) {
        printf("Usage: ./main [image dir] [onnx file|model name] [plan file optional]\n");
        printf("Example: ./main ../images yolo11s-pose\n");
        printf("Example: ./main ../images ../onnx_model/yolo11s-pose.onnx ./yolo11s-pose.plan\n");
        return 1;
    }
